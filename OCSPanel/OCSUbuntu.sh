...
read -p "Database Name    : " -e -i DBname NamaDatabase
echo "Input MySQL Password:"
echo "(Use different Password for your database, dont use VPS password.)"
read -p "Database Password: " -e -i pass PasswordDatabase
echo ""
...
# update
apt-get -y update
apt-get install checkinstall build-essential -y && apt-get -y install cmake && apt-get -y install expect
...
#Install Webserver
apt-get -y install nginx php php-fpm php-cli php-mysql
...
echo "Script Created By Dexter Cellona Banawon ( https://fb.com/theMovesFever )"   		| tee -a log-install-ocspanel.txt
echo "Modified by La Luna"                      	                 	| tee -a log-install-ocspanel.txt
echo "--------------------------------------------------------------------------------"| tee -a log-install-ocspanel.txt
echo ""
echo ""
cd
